...
<html lang="en">
    ...
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="<?php bloginfo('templete_url');?>/plantilla/admin/vertical/assets/images/favicon.ico">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"
                                ...
                                <div class="p-2 border-top">
                                    <a class="btn btn-sm btn-light btn-block text-center" href="javascript:void(0)">
                                        <i class="mdi mdi-arrow-down-circle mr-1"></i> conducir más
                                    </a>
                                </div>
                            </div>
                        </div>
...
<div data-simplebar class="h-100">
    ...
    <div id="sidebar-menu">
        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li>
                <a href="preguntas_frecuentes.php" class="waves-effect" ><i ><i
                    class="mdi mdi-home"></i></i><span
                        class="badge badgi-homee-pill badge-primary float-rightmdi md "></span><span>Preguntas Frecuentes</span></a>
            </li>
            <li>
                <a href="cuestionario.php" class="waves-effect" ><i ><i
                    class="mdi mdi-home"></i></i><span
                        class="badge badgi-homee-pill badge-primary float-rightmdi md "></span><span>Cuestionario</span></a>
            </li>
